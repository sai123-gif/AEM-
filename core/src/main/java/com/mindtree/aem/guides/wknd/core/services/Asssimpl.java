...
@Component(name = "Asss", service = Asss.class, immediate = true)
...
public class Asssimpl implements Asss {
	...
	private static final Logger logger = LoggerFactory.getLogger(Asss.class);
	...
	String path = "";
	Resource res = resourceresolver.getResource("/content/wknd/language-masters");
